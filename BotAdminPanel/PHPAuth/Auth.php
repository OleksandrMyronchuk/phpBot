...
require_once 'ZxcvbnPhp/Zxcvbn.php';
require_once 'ZxcvbnPhp/Matcher.php';
require_once 'ZxcvbnPhp/Scorer.php';
require_once 'ZxcvbnPhp/TimeEstimator.php';
require_once 'ZxcvbnPhp/Feedback.php';
require_once 'ZxcvbnPhp/Matchers/DateMatch.php';
